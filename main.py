        ...
        <main class="row">
            <div class="row text-center">
                ...
                <p class="d-inline-flex gap-1">
                  <button class="btn btn-success form-control" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample1" aria-expanded="false" aria-controls="multiCollapseExample1">Как купить?</button>
                  <button class="btn btn-success form-control" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">Как доставить?</button>
                  <button class="btn btn-success form-control" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample3" aria-expanded="false" aria-controls="multiCollapseExample3">Какая гарантия?</button>
                </p>
                <div class="row">
                  <div class="col">
            ...
            <table class="table table-hover table-bordered border-dark">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>10</td>
                  <td>25000</td>
                  <td class="table-light">Обработка</td>
                </tr>
                <tr>
                  <th scope="row">3</th>
                  <td>Шарф</td>
